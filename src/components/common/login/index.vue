<template>
  ...
  <el-form class="form-container column-center">
    <el-form-item class="row-center">
      <p>用户名：</p><el-input aria-placeholder="请输入用户名" type="text"></el-input>
    </el-form-item>
    <el-form-item class="row-center">
      <p>密&nbsp;码：</p><el-input aria-placeholder="请输入用户名" type="password"></el-input>
    </el-form-item>
  ...
  mounted() {
    ...
    function Circle(xCoordinate, yCoordinate, radius) {
      ...
      this.draw = function() {
        ...
        // c.font = '66px Adobe Ming Std';
        // c.fillText('让自己配得上!',390,200);
...
<style lang="scss">
  .form-container {
    ...
    position: absolute;
    right:40%;bottom:40%;left: 40%;top:40%;
  }
